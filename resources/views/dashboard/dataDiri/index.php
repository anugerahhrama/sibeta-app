        ...
        <form action="data-diri-proses" method="POST">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input name="tempat_lahir" value="<?php echo htmlspecialchars($userData['tempat_lahir'] ?? ''); ?>" type="text" id="tempat_lahir" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Tempat Lahir" required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input name="tgl_lahir" id="datepicker-autohide" datepicker datepicker-format="yyyy-mm-dd" datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Select date">
                ...
                <div>
                    ...
                    <input name="no_tlp" value="<?php echo htmlspecialchars($userData['no_tlp'] ?? ''); ?>" type="text" id="no_hp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Nomor Hp Anda" required />
                </div>
            </div>
