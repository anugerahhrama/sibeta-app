...
<div class="p-6 sm:ml-64">
    ...
    <div class="p-6 border-2 rounded-2xl">
        ...
        <form action="<?= $router->route('admin/prodi.index') ?>/store" method="POST">
            <table class="w-full mb-4">
                <tr>
                    ...
                    <td>
                        <input type="text" id="nama" name="nama" value="" class="mb-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
                    </td>
                </tr>
            </table>
