        ...
        <form action="<?= BASE_URL ?>admin/pengguna/store" method="POST">
            <table class="w-full mb-4">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="" name="nim" value="" class="mb-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-2" />
                    </td>
                </tr>
                <tr>
                    <td class="text-start font-medium text-base w-fit">
