...
<div class="p-6 sm:ml-64">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex gap-x-2">
            ...
            <a href="<?= $router->route('admin/pengguna.create') ?>" class="text-gray-900 bg-[#FEBF10] hover:bg-[#FEBF10]/80 focus:ring-4 focus:ring-[#FEBF10] font-medium rounded-full text-sm px-5 py-2.5 focus:outline-none">
                Tambah
            </a>
        </div>
    </div>
                                ...
                                <?php foreach ($datas as $key => $row) { ?>
                                    <?php if ($row['role'] === '1') { ?>
                                        <tr class="bg-white text-gray-600">
                                            ...
                                            <td class="px-6 py-2">
                                                <?= htmlspecialchars($row['no_tlp'] ?? '-') ?>
                                            </td>
                                            <td class="px-6 py-2">
                                                <div class="flex gap-x-1">
                                                    <form action="<?= BASE_URL ?>admin/pengguna/delete/<?= $row['user_id'] ?>" method="POST">
                                                    ...
                                                    <a href="<?= $router->route('admin/pengguna.edit', ['id' => $row['user_id']]) ?>" class="p-2.5 rounded-xl hover:bg-gray-200">
                                                        <svg class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
