...
// Langkah 2: Iterasi melalui data yang telah dikelompokkan
    foreach ($groupedData as $prodiName => $items) { ?>
        ...
        <div class="flex justify-end mt-16 gap-2">
            ...
            <a href="<?= $router->route('bantuan-edit') ?>" id="editButton" class="font-medium text-base text-white px-6 py-2.5 bg-[#0D6EFD] hover:bg-[#0C5CCA] rounded-2xl focus:ring-4 focus:ring-[#0D6EFD]">
                Edit
            </a>
        </div>
    </div>
