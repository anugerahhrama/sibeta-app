    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <a href="<?= BASE_URL ?>" class="block py-2 px-3 text-gray-900 rounded hover:text-white hover:bg-[#0F1F43] md:hover:bg-transparent md:border-0 md:hover:text-[#FEBF10] md:p-0" aria-current="page">Beranda</a>
          </li>
          <li>
            <a href="<?= BASE_URL ?>#fitur" class="block py-2 px-3 text-gray-900 rounded hover:text-white hover:bg-[#0F1F43] md:hover:bg-transparent md:border-0 md:hover:text-[#FEBF10] md:p-0">Fitur</a>
          </li>
          <li>
            <a href="<?= BASE_URL ?>#faq" class="block py-2 px-3 text-gray-900 rounded hover:text-white hover:bg-[#0F1F43] md:hover:bg-transparent md:border-0 md:hover:text-[#FEBF10] md:p-0">FAQ</a>
          </li>
          <li>
            <a href="<?= BASE_URL ?>#tentangkami" class="block py-2 px-3 text-gray-900 rounded hover:text-white hover:bg-[#0F1F43] md:hover:bg-transparent md:border-0 md:hover:text-[#FEBF10] md:p-0">Tentang Kami</a>
          </li>
...
<section id="login" class="h-screen flex items-center justify-center" style="background-image: linear-gradient(rgba(255, 255, 255, 0.97), rgba(255, 255, 255, 0.97)), url(/public/assets/img/landingPage/topography.svg); background-size: cover; background-repeat: no-repeat;">
  <!-- Hero utama -->
  <div class="flex flex-col md:flex-row overflow-hidden mt-40 mb-20 gap-8  justify-center items-center">
    <!-- Bagian gambar -->
    <div class="md:w-1/2 h-full m-10 rounded-lg hidden md:block">
      <img src="public/assets/img/landingPage/GedungSipil.svg" alt="Gambar Gedung Sipil" class="h-full w-full object-cover">
    </div>

    <!-- Bagian form -->
    <div class="md:w-1/2 flex flex-col justify-center bg-white rounded-2xl border m-5 md:m-10 h-full p-10 md:py-20">
