...
<section id="register" class="h-screen flex items-center justify-center bg-cover bg-no-repeat"
    ...
    <div class="flex flex-col md:flex-row overflow-hidden mt-40 mb-20 gap-16  justify-center items-center">

        <!-- Bagian Gambar -->
        <div class="md:w-1/2 h-full rounded-lg bg-center bg-contain hidden md:block">
        ...
        <!-- Bagian Form -->
        <div class="md:w-1/2 p-10 m-5 flex flex-col justify-center bg-white rounded-2xl border">
